...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [3942244.432923, 78162.525269, 3945948.328169, 80027.388335], maxZoom: 28, minZoom: 1
    })
});
...
layerSwitcher.showPanel();
    ...
    var searchLayer = new SearchLayer({
      layer: lyr_Keneya_Growth_Status_1,
      colName: 'crop',
      zoom: 10,
      collapsed: true,
      map: map
...
map.getView().fit([3942244.432923, 78162.525269, 3945948.328169, 80027.388335], map.getSize());
